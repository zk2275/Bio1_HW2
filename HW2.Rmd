...
For the sample mean, $\bar{X} \sim N(80,100)$.
So, for the population mean,  $X \sim N(80,4000)$.

$$z_{0.025} \le \frac{x-\mu}{\sigma} \le z_{0.975}$$

$$z_{0.025}\sigma+\mu \le x \le z_{0.975}\sigma+\mu,z_{0.025}=-z_{0.975}=-1.96$$

$$-43.96\le x \le 203.96$$
Accoring to the actual situation: 
$$0< x \le 203.96$$
...
Because it's the confidence interval for the population, so it's much wider than the sample mean's confidence interval. 

That means when we use the interval(0<x<203.96) to cover the population mean pulse rate of young females suffering from fibromyalgia for 100 times, there are always 95 times to make it.
